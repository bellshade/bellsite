...
<div>
	...
	>
		...
		>
			<div class="flex flex-col space-y-2 items-center grow">
				{#if project.image}
					<img
						src={project.image}
						alt={project.name}
	 				...
	 				/>
				{:else}
					<div class="mb-3 h-48 w-full flex items-center justify-center bg-zinc-200 border border-zinc-300 rounded-lg">
